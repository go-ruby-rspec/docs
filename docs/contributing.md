...
Contributions are welcome. `go-ruby-rspec/rspec` is built to a small set of
...
The library is in [`github.com/go-ruby-rspec/rspec`](https://github.com/go-ruby-rspec/rspec).
This documentation site is in [`github.com/go-ruby-rspec/docs`](https://github.com/go-ruby-rspec/docs).
