...
The public API lives at the module root (`github.com/go-ruby-rspec/rspec`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rspec`, while the surface follows
...
```go
import "github.com/go-ruby-rspec/rspec"
```
...
- **[pkg.go.dev/github.com/go-ruby-rspec/rspec](https://pkg.go.dev/github.com/go-ruby-rspec/rspec)**

The module's [README](https://github.com/go-ruby-rspec/rspec#readme) carries worked
