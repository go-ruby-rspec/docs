# go-ruby-rspec documentation

**Pure-Go, MRI-faithful Ruby rspec (no cgo)**

`go-ruby-rspec/rspec` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rspec`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rspec`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`rspec`](https://github.com/go-ruby-rspec/rspec) | the library — Ruby's `rspec` in pure Go |
| [`docs`](https://github.com/go-ruby-rspec/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rspec.github.io`](https://github.com/go-ruby-rspec/go-ruby-rspec.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rspec/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rspec/rspec](https://github.com/go-ruby-rspec/rspec).
